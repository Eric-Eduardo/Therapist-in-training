...
name: nome do personagem que está falando na cena
text: texto da fala
imgPerson: imagem do personagem no momento da fala
*/

function preloadJoao() {
    joao01 = loadImage('img/joao/joao_01.png');
...
let cena1 = {
    cenas: [
        ...
        {
            name: "Psicólogo",
            text: "Fico feliz que tenha conseguido vir hoje, mesmo com as dificuldades. Como você está se sentindo agora?",
            imgPerson: "neutro"
        },
        {
            name: "João",
        ...
        {
            name: "Psicólogo",
            text: "Se precisar, podemos tirar um minuto para você respirar e se sentir mais á vontade. Toma um pouco de água e me conta devagar, o que está te incomodando.",
            imgPerson: "neutro"
        }
    ],
    nextTela: "cenaMenu",
...
let cena2 = {
    cenas: [
        {
            name: "João",
            text: "João: Meu nome é João, tenho 29 anos. Eu trabalho como analista de sistemas em uma empresa de tecnologia, mas, ultimamente, as coisas não têm ido muito bem.",
            imgPerson: "falando"
        },
        {
            name: "João",
...
let cena3 = {
    cenas: [
        {
            name: "João",
            text: "João: Bem, acho que... o que me trouxe até aqui é que minha vida tem sido um turbilhão nos últimos meses.",
            imgPerson: "falando"
        },
        {
            name: "João",
...
let cena4 = {
    cenas: [
        ...
        {
            name: "João",
            text: "Eu... Eu tenho me sentido muito sobrecarregado no trabalho, e tem sido difícil dormir, pensar em outra coisa que não seja o trabalho, sabe? Tenho medo de errar, de decepcionar as pessoas. É tudo parece tão urgente... parece que estou perdendo o controle.",
            imgPerson: "preocupado"
        }
    ],
    nextTela: "cenaMenu",
...
let cena5 = {
    cenas: [
        {
            name: "João",
            text: "É, talvez você tenha razão. Eu... não queria parecer fraco, eu acho. Mas tem sido difícil, não sei mais como lidar com tudo.",
            imgPerson: "cabeça baixa"
        }
    ],
    nextTela: "cenaMenu",
...
let cena6 = {
    cenas: [
        {
            name: "João",
            text: "Sim, tem afetado bastante.",
            imgPerson: "falando"
        },
        {
            name: "João",
            text: "Eu mal consigo passar tempo com minha família ou amigos. Quando estou em casa, estou tão cansado que não consigo me concentrar nas conversas ou aproveitar o tempo com eles.",
            imgPerson: "cabeça baixa"
        },
        {
            name: "João",
            text: "Isso tem gerado um certo distanciamento, e eu sinto falta dessa conexão;",
            imgPerson: "preocupado"
        }
    ],
    nextTela: "cenaMenu",
...
let menu1 = [
    ...
    {
        text: "Parece que os últimos meses têm sido muito intensos para você. O que tem demandado mais da sua energia?",
        pontuacao: 0,
        nextTela: "cena",
        jump: "cena3"
    },
    {
        text: "Sei que ás vezes chegar aqui pode ser um desafio, especialmente quando estamos passando por tantas coisas. Vamos começar devagar, me conta um pouco sobre você.",
        pontuacao: 2,
        nextTela: "cena",
        jump: "cena3"
    },
